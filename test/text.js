...
describe('Text', () => {
  ...
  describe('TEXTSPLIT', () => {
    ...
    it('should split with col_delimiter', () => {
      ...
      expect(text.TEXTSPLIT('Do. Or do not. There is no try. -Anonymous', ['.', ' ', 'Do'])).to.deep.equal(
    ...
    describe('with col_delimiter and row_delimiter', () => {
      ...
      it('should split prior to col_delimiter if same as row_delimiter when array row provided', () => {
        expect(text.TEXTSPLIT('Do. Or do not. There is no try. -Anonymous', [ '.', ' ' ], '. ' )).to.deep.equal(
          [
            [ 'Do', '', 'Or', 'do', 'not', '', 'There', 'is', 'no', 'try', '', '-Anonymous' ]
          ]
